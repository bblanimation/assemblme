...
def handle_exception(log_name:str, report_button_loc:str):
    ...
    error_str = "Something went wrong. Please report the error with us so we can fix it! ('%(report_button_loc)s')" % locals()
    print("\n"*5)
    print("-"*98)
    print(error_str)
    print("-"*98)
...
def write_error_to_file(error_report_path:str, error_log:str, addon_version:str, tracker_url:str):
    # write error to log text object
    ...
    f.write("\nPlease copy the following form and paste it into a new email with us (our contact info can be found here: " + tracker_url + ")")
    ...
    f.write("\nBlender Version: " + str(bpy.app.version))
